...
- AZ란?
    Availability Zone으로 AWS의 독립적인 데이터센터인 리전(e.g. ap-northeast-2)이 있고, 리전 내엔 AZ(e.g. ap-northeast-2a, ap-northeast-2b...)가 있습니다.
# 핵심 필기
## 수직 스케일링 하기
**필요 조건**
...
- **해결 방법**
	...
	- 방법2. 인스턴스 제한 증가 시키기 -> Service Quotas 들어가서 설정 가능
